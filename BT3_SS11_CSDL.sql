...
BEGIN
    SET SalaryInput = SalaryInput * 1.1;
...
SET @Salary = (SELECT Salary FROM Employees WHERE EmployeeID = 3);
CALL IncreaseEmployeeSalary(3, @Salary);
